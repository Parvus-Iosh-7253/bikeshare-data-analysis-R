...
provided datasets, and generating relevant visuals to go with my analysis. The questions I asked were:
  ...
  - Which gender takes the most trips? Has the longest average trip?

The script has been rendered into an html document so that the included markdown can be seen correctly, and so that 
the full report including graphics is easily readable.
